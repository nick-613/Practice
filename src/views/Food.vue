...
<div class ="card hover:shadow-lg hover:shadow-black transition-all rounded-lg">
  <h1 class = "mb-2 py-2 px-2" style="color: black; font-family:verdana;">Sauerkraut</h1>
...
<div class ="card hover:shadow-lg hover:shadow-black transition-all rounded-lg mb-9">
  <h1 class = "mb-2 py-2 px-2" style="color: black; font-family:verdana;">Hot Dogs</h1>
...
<div  class ="card hover:shadow-lg hover:shadow-black transition-all rounded-lg">
  <h1 class = "mb-2 py-2 px-2" style="color: black; font-family:verdana;">Beef Burrito</h1>
  <div style="color:black;">I hated this food </div>
...
<div class = "rightcolumn2">
  <div class ="specialsaur hover:shadow-lg hover:shadow-black transition-all mb-28"></div>
    <div class ="specialHD hover:shadow-lg hover:shadow-black transition-all mb-13"></div>    
    <div class ="specialBurr hover:shadow-lg hover:shadow-black transition-all mb-2"></div>
</div>
</div>
