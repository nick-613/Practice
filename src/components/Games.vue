...
Lethal Company is a 2023 co-op horror game developed by Zeekerss and released for Microsoft Windows through Steam Early Access on October 23, 2023.

Setting and Story:

Lethal Company takes place in a retrofuturistic post-apocalyptic setting where players assume the role of contracted employees working for a corporation named The Company. The game's story revolves around players scavenging and collecting scrap from various abandoned, industrialized moons while facing numerous dangers such as:

Environmental hazards: Players must navigate through hazardous environments containing toxic fumes, radiation, and extreme temperatures.
...
The game features a dual protagonist narrative, allowing players to switch between both Peter Parker and Miles Morales, each with their own unique combat styles, abilities, and personal struggles. This dual perspective adds depth and variety to the gameplay,
...
Mortal Kombat 1 revisits the iconic tournament but takes place in a timeline altered by the actions of Fire God Liu Kang. This creates a familiar yet radically different setting, allowing the game to introduce new storylines and character arcs while still honoring the rich history of the franchise.</div>
  </div>
  </div>
