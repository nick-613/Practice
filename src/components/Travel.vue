...
Forks, Washington is a small but captivating city nestled in the Olympic Peninsula on the Pacific Coast. Renowned for its breathtaking natural beauty, rich history, and intriguing connection to the Twilight saga, Forks is a destination that offers something for everyone.
...
A Diverse Landscape:</div>
  ...
  <div class = "rightcolumn2">
    <div class ="special hover:shadow-lg hover:shadow-black transition-all mb-3"></div>
    <div class ="specialcdmx hover:shadow-lg hover:shadow-black transition-all mb-3"></div>    
    <div class ="specialgtav hover:shadow-lg hover:shadow-black transition-all mb-3"></div>
  </div>
  </div>
